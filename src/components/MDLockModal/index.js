...
function MDLockModal({ isOpen, confirmLock, title, message, cancelAction, isLoading }) {
  return (
    <div>
      <Modal
        open={isOpen}
      ...
      >
        <MDBox sx={style}>
          ...
          <Stack direction="row" spacing={2}>
            ...
            <MDButton variant="gradient" color="error" onClick={confirmLock}>
...
MDLockModal.propTypes = {
  isOpen: PropTypes.bool.isRequired,
  isLoading: PropTypes.bool.isRequired,
  confirmLock: PropTypes.func.isRequired,
  cancelAction: PropTypes.func.isRequired,
  title: PropTypes.string.isRequired,
  message: PropTypes.string.isRequired,
};

export default MDLockModal;
